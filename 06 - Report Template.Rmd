...
2. **You (kind of) know what you want to do but don't know how to do it in R**
    ...
    * Check out the canonical textbook for the tidyverse, [R for Data Science](https://r4ds.had.co.nz/)
...
2. Post your question on the [Path Learner Slack Channel](https://pathlearnr.slack.com)
